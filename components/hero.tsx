  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#e20074] font-semibold">T-Mobile Method</span>{" "}
        ...
        >
          Discover how people are saving on devices, plans, accessories, and everyday wireless essentials.
        </p>
        ...
        >
          <a
            href="https://trksy.org/aff_c?offer_id=4414&aff_id=26188"
            target="_blank"
            rel="noopener noreferrer"
            className="touch-button group inline-flex items-center gap-3 bg-[#e20074] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#b8005d] transition-all duration-300 hover:shadow-xl hover:shadow-[#e20074]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
        ...
        >
          ...
          <p className="text-sm text-muted-foreground/70 font-medium">
            <span className="sm:hidden">Join 12,000+ mobile users who&apos;ve<br />already claimed their rewards.</span>
            <span className="hidden sm:inline">Join 12,000+ mobile users who&apos;ve already claimed their rewards.</span>
          </p>
        </div>
      </div>
    </section>
