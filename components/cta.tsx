...
import { ArrowRight, Gift, Sparkles, Smartphone } from "lucide-react";
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-12 pb-16 sm:pt-16 sm:pb-20 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#e20074] rounded-3xl p-8 sm:p-12 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Join thousands of mobile users who have already claimed their $1000 T-Mobile reward. Your savings are just a few clicks away.
            </p>
            ...
            >
              <a
                ...
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#e20074] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/95 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
